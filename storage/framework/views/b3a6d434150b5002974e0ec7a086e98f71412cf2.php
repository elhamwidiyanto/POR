                    ...
                    <?php if($apps->first()): ?>
                        <?php $__currentLoopData = $apps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $app): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center"><a<?php echo e($app->target); ?> href="<?php echo route('items.edit', [$app->id]); ?>" title="<?php echo e(__('app.settings.edit')); ?> <?php echo e($app->title); ?>"><i class="fas fa-edit"></i></a></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PORTAL\resources\views/items/list.blade.php ENDPATH**/ ?>